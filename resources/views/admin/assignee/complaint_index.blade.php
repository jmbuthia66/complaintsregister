    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
                ...
                <div class="d-inline">
                    <h5>Complaints</h5>
                    <span>List of all Complaints Assigned To {{auth()->user()->name}}</span>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
                    ...
                    <tr>
                        ...
                        <td>@if($complaint->status=='')
                         ...
                         <td>
                            ...
                            <a href="{{route('complaintedit.assignee',[$complaint->id])}}"><i class="ik ik-edit-2"></i></a> 
