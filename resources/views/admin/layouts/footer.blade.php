                    ...
                    <div class="modal-body d-flex align-items-center">
                        <div class="container">
                            <div class="apps-wrap">
                                ...
                                <div class="app-item">
                                    <a href="{{route('doctor.create')}}"><i class="ik ik-users"></i><span>Create Users</span></a>
                                </div>
                                <div class="app-item">
                                    <a href="{{route('doctor.index')}}"><i class="ik ik-users"></i><span>View Users</span></a>
                                </div>
                                <div class="app-item">
                                    <a href="{{route('doctor.create')}}"><i class="ik ik-edit"></i><span>Create Complaints</span></a>
                                </div>
                                <div class="app-item">
                                    <a href="{{route('doctor.index')}}"><i class="ik ik-edit"></i><span>View Complaints</span></a>
                                </div>
                                <div class="app-item">
                                    <a href="{{route('doctor.create')}}"><i class="ik ik-edit"></i><span>Create Suggestions</span></a>
                                </div>
                                <div class="app-item">
                                    <a href="{{route('doctor.index')}}"><i class="ik ik-edit"></i><span>View Suggestions</span></a>
                                </div>
                               <!-- <div class="app-item">
