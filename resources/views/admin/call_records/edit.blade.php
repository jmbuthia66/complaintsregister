    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
                ...
                <div class="d-inline">
                    <h5>Call Record</h5>
                    <span>Update Call Record CR000{{$call_record->id}}</span>
                </div>
            </div>
        </div>
    <div class="col-lg-4">
...
<div class="row justify-content-center">
	...
	<div class="card-body">
		<form class="forms-sample" action="{{route('call_record.update',[$call_record->id])}}" method="post" enctype="multipart/form-data" >@csrf
            @method('PUT')
