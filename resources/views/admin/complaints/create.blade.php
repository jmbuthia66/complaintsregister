    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
                ...
                <div class="d-inline">
                    <h5>CUSTOMER INCIDENT REGISTRATION</h5>
...
<div class="row justify-content-center">
    ...
    <div class="card-body">
        <form class="forms-sample" action="{{route('complaint.store')}}" method="post" enctype="multipart/form-data" >@csrf
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="assignee" class="form-control">
                            <option value="">Please select</option>
                            <option value="No Assignee">No Assignee Needed</option>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">Assignee Email</label>
             ...
             <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        @foreach(App\Models\Point::all() as $t)
